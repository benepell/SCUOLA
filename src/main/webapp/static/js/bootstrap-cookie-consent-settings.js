...
function BootstrapCookieConsentSettings(props) {
    ...
    this.props = {
        ...
        defaultLang: "it", // default language, if `lang` is not available as translation in `cookie-consent-content`
...
<div class="modal-dialog modal-lg shadow" role="document">
    ...
    function showDialog() {
        documentReady(function () {
            ...
            // sposta la modale in basso
            const modalDialog = document.querySelector(".modal-dialog");
            const windowHeight = window.innerHeight;
            const modalHeight = modalDialog.offsetHeight;
            const modalVerticalPosition = windowHeight / 4- modalHeight / 4;
            modalDialog.style.marginTop = modalVerticalPosition + "px";
        }.bind(this))
    }
