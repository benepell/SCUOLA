...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain', 'video/mp4', 'application/x-tgif' ), // Mimetype `image` and `text/plain` allowed to upload
